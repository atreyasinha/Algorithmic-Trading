    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Alpaca_KeyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Portfolio_Alpaca_Keys_Alpaca_KeyId",
                        column: x => x.Alpaca_KeyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Portfolio_Alpaca_KeyId",
                table: "Portfolio",
                column: "Alpaca_KeyId",
                unique: true);
        }
